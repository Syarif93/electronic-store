...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{asset('plugins/admin_plugins/fontawesome-free/css/all.min.css')}}">
  <!-- Ionicons -->
...
<!-- jQuery -->
<script src="{{asset('plugins/admin_plugins/jquery/jquery.min.js')}}"></script>
<!-- Bootstrap 4 -->
<script src="{{asset('plugins/admin_plugins/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
<!-- AdminLTE App -->
