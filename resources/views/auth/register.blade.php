            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="kode_post" class="col-md-4 col-form-label text-md-right">{{ __('Kode Pos') }}</label>

                            <div class="col-md-6">
                                <input id="kode_post" type="text" class="form-control @error('kode_post') is-invalid @enderror" name="kode_post" value="{{ old('kode_post') }}" required autocomplete="kode_post" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="telephone" class="col-md-4 col-form-label text-md-right">{{ __('No Telfon') }}</label>
